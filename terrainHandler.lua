...
local function SetupWorld(width, height)
	...
	AddTrack({2 + 5, -1 + 7}, "curve", 0)
	AddTrack({3 + 5, -1 + 7}, "straight", 0)
	AddTrack({4 + 5, -1 + 7}, "sawmill", 0)
	AddTrack({5 + 5, -1 + 7}, "straight", 0)
	AddTrack({6 + 5, -1 + 7}, "town", 0)
	AddTrack({7 + 5, -1 + 7}, "straight", 0)
