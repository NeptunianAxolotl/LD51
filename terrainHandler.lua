...
local function SetupWorld(width, height)
	...
	AddTrack({5, 4}, "signal", 1)
	AddTrack({5, 5}, "cross", 1)
	AddTrack({5, 6}, "curve", 3)
	AddTrack({6, 6}, "curve", 2)
	AddTrack({6, 5}, "curve", 1)
	AddTrack({4, 5}, "straight", 0)
	AddTrack({3, 5}, "straight", 0)
	AddTrack({2, 5}, "curve", 3)
	AddTrack({2, 4}, "straight", 1)
	AddTrack({2, 3}, "straight", 1)
end
